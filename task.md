...
Цель
Сопоставить компании в двух наборах данных на основе названий компаний и их местоположений и получить объединенный результат.

Наборы данных
DATAFOREST - ЗАДАНИЕ ДЛЯ ТЕСТИРОВАНИЯ
...
2. Создайте объединенный набор данных, который:
...
Результаты работы
1. Объединенный набор данных (CSV)
2. Скрипты кода
3. Документация:
○ подход к сопоставлению
○ обнаружены проблемы с качеством данных
○ применена нормализация/преобразования
○ рассчитаны метрики